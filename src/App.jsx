...
function App() {
  ...
  const isStore = location.pathname.startsWith('/store-dashboard');
   const isProductUpload = location.pathname.startsWith('/store-product-upload')
   const isOrders = location.pathname.startsWith('/store-orders')
   const isOrderHistory = location.pathname.startsWith('/store-order-history')
   const isProduct = location.pathname.startsWith('/store-product')
   const isProfile = location.pathname.startsWith('/store-profile')
   const isNotification = location.pathname.startsWith('/store-notification')

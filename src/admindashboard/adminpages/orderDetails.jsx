...
const {id} = useParams();
const item =  realorderdata.find((item) => item.id === id);
...
style={{ boxShadow: "0px 8px 32px 0px #3326AE14"}}>
    ...
    <div className="">
        <h1 className="text-[#282828] text-[24px] leading-[36px] font-[700] font-tekInter"> order ID: {item.orderId}</h1>
    </div>
...
<div className="flex flex-col my-[1rem] gap-[24px]">
    <h1 className="font-[400] text-[16px] leading-[20px] text-[#282828] font-tekInter">Please notify on the status of this Order</h1>
    <ul className="flex flex-col md:flex-row gap-[24px]">
        <li className="pt-[12px] pr-[20px] pb-[12px] pl-[20px] border-[1px] border-[#1843E2] rounded-[8px] gap-[8px]">
            <h1 className="font-[600] text-[16px] leading-[24px] text-[#1843E2] font-tekInter">No, hasn’t seen a rider</h1>
            </li>
            <li className="pt-[12px] pr-[20px] pb-[12px] pl-[20px] border-[1px] bg-[#1843E2] border-[#1843E2] rounded-[8px] gap-[8px]"
            
            style={{ boxShadow:"0px 1px 2px 0px #1018280D"}}>
            <h1 className="font-[600] text-[16px] leading-[24px] text-[#FFFFFF] font-tekInter">Yes, the rider has pick it up </h1>
            </li>
    </ul>

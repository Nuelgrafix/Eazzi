...
const RiderSignup = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
     await axios.post(
        "https://django-7u8g.onrender.com/api/dispatch-riders/register/",
        formData
      );
  ...
  return (
    <div className="absolute z-50 bg-white w-full pb-36 md:pb-0">
      ...
      <div className="w-full flex flex-col md:flex-row items-center justify-between md:px-0">
        ...
        <div className="w-full mt-[65px] md:mt-[100px] md:px-10 lg:px-20">
          ...
          >
            ...
            <div>
              ...
              />
              {errors.phone && (
                <p className="text-red-600 text-[15px]">{errors.company}</p>
              )}
            </div>
            ...
            <div>
              ...
              />
              {errors.location && (
                <p className="text-red-600 text-[15px]">{errors.location}</p>
              )}
            </div>
        ...
        Don&apost have account? <Link to="/signup" className="text-[#1843E2]">Sign up</Link>
      </p>
          </div>
        </div>
      </div>

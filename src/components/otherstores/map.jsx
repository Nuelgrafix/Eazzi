...
const Map = () => {
  ...
  return (
    <section
      className="fixed inset-0 flex flex-col z-[1000] md:items-center items-end justify-end  md:justify-center   
"
    >
      <div
        className="flex flex-col md:w-[1024px] md:h-[550px] h-[77vh] 
  md:rounded-[30px] rounded-[50px]  bg-[#fff] relative items-center justify-center mt-[4rem]  w-full"
      >
        ...
        {/* Enter a location */}
        <div
          className="flex flex-col text-center items-center shadow-lg justify-center 
     bg-[#fff] md:w-[833px] w-[100%]  md:h-[293px] h-[70%]  md:mb-[5rem]  
    mt-[-2rem] relative z-10 "
        >
          <h1 className="md:pt-[1rem] pt-[2rem] w-[400px] font-[400] text-[24px] leading-[36px] pb-[0.5rem]">
            Enter a Location do you prefer to shop from
          </h1>
         ...
         outline-none border-none bg-transparent"
          ...
          <div className="mt-4 pb-[1rem] flex items-center justify-center">
            <img
              src={warningicon}
              alt="warning_icon"
              className="w-[16px] h-[16px] pr-[1rem]"
            />
            <h1 className="flex items-center">
              Please note that shopping from a distant location takes a little

  ...
  return (
    <section>
      <div className="flex flex-col  ">
        ...
        <div className="mt-[2rem]">
          {/* heading */}
          <div
            className="max-w-[100%] flex justify-between
         items-center h-[73px] bg-[#F9F9F9]  md:bg-mainBlue md:border-b-4 md:border-secondOrange md:px-[1rem] p-[0.5rem]"
          >
        ...
        <div className="mt-[2rem] bg-[#fff]">
          {/* heading */}
          <div
            className="max-w-[100%] flex justify-between
       items-center h-[73px] bg-[#F9F9F9] md:bg-mainBlue 
      md:border-b-4 md:border-secondOrange px-[0.5rem]"
          >
            <div className="flex items-center gap-3">
              <h1 className="text-[#181818] md:text-[#fff] font-[400] text-[18px] leading-[19px]  font-tekInter">
                Top selling stores
              </h1>
            </div>

            <h1 className=" md:text-[#fff] text-mainBlue  font-[600] text-[14px] leading-[16px]  flex gap-2 font-tekInter ">
              View all stores
          ...
          {/* body */}
          <div
            className="md:flex  justify-center gap-3 pb-[3rem] 
      p-[3rem]  hidden"
          >
            {/* first box */}
    ...
    items-center text-center bg-mainBlue text-[16px] mt-[1rem]"
          ...
          <div className="md:hidden w-[100%] p-2">
            <Slider
              {...settings}
              className="gap-3 flex p-[1rem]  rounded-[5px]"
            >
              {/* first box */}
              <div

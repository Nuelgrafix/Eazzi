  ...
  const handleGoogleSuccess = async (response) => {
    ...
    try {
      ...
      if (res.data.access) {
        ...
        navigate(`/store-createaccount/${res.data.id}`); // ✅ Redirect to store dashboard
      }
        ...
        <GoogleLogin
          ...
          render={(renderProps) => (
            <button
              ...
              className="bg-white border border-gray-300 rounded-lg flex items-center justify-center p-2 w-[250px] shadow-md hover:bg-gray-100 transition"
            >
              <img

...
const FilledCart = () => {
  ...
  const handleMinusCartItem = () => {
    setCartItem(prevCartItem => Math.max(prevCartItem - 1, 0));
  };
...
<i className="ri-arrow-left-line text-[20px] text-[#282828]"></i>
 ...
 bg-[#F9F9F9] px-[1rem]"
        >
            ...
            {saveditemsdata.map((s) => (
              ...
              >
               ...
               #2,570                  </h1>
                  ...
                  >
                    <li className="w-[40px] h-[40px] bg-[#5075FF] flex items-center justify-center text-[#FFFFFF] text-[16px] leading-[19px] font-[700] rounded-[8px]"  onClick={handleMinusCartItem}>
                   -
                    </li>
                    <li   className=" text-[#FF7F00] text-[16px] leading-[19px] font-[700] font-tekInter">{cartitem} </li>
                  <li onClick={handleAddCartItem} className="w-[40px] h-[40px] bg-[#5075FF] flex items-center justify-center text-[#FFFFFF] text-[16px] leading-[19px] font-[700] rounded-[8px]">
                   +
                    </li>
                  </ul>
                </div>
          ...
          <div
            className="md:w-[335px] h-auto md:h-[199px]  flex-col gap-[32px] bg-white  mt-4   py-[24px] px-[16px]
     hidden md:flex "
          ...
          >
            ...
            <li>{cartitem} Saved Product</li>
            <li className="fontt-[700] text-[#282828] font-[700] text-[16px] leading-[19px] font-tekInter">#{totalprice}</li>
            </ul>

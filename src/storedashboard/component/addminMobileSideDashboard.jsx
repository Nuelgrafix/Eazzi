...
const AdminMobileSideDashboard = () => {
    
  return (
    <section className="h-full  flex flex-col gap-[77px] 
    pt-[38px] pr-[38px] pb-[38px] pl-[24px] w-[214px]">
        ...
        <Link to="/product-upload"  className="bg-[#FF7F00] gap-[8px] rounded-[8px] border-[1px] border-[#FF7F00] text-[#FFFFFF] text-[16px] leading-[24px] font-[600] font-tekInter pt-[12px] pr-[20px] pb-[12px] pl-[20px]" 
...
export default AdminMobileSideDashboard;
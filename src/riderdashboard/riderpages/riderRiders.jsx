...
import RidersDeliveryGroup from "../component/ridersDeliveryGroup";
import AllRiders from "../component/allRiders";
...
<div className="w-full flex items-center justify-between">
    <div>
        <h1 className="outline-none w-full h-full lg:text-[32px] text-[24px]
         leading-[48px] text-[#1843E2] font-tekInter font-[700]">Riders</h1>
    </div>

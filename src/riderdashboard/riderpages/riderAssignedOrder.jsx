...
<div className="w-full flex items-center justify-between py-[1rem]">
    <div>
        <h1 className="outline-none w-full h-full lg:text-[32px] text-[24px] leading-[48px] text-[#5075FF] font-tekInter font-[700]">Assign Order</h1>
    </div>
...
<div className="flex flex-col my-[1rem] gap-[24px]">
    <h1 className="font-[400] text-[16px] leading-[20px] text-[#333333] font-tekInter max-w-[486px]">
        You are about to Assign the above Order to Rider William Olayemi. Rider ID; EL001AJA</h1>
    <ul className="flex flex-col md:flex-row gap-[24px]">



    <li className="pt-[12px] pr-[20px] pb-[12px] pl-[20px] border-[1px] bg-[#F9F5FF]  border-[#1843E2] 
            rounded-[8px] gap-[8px]"
            style={{ boxShadow:"0px 1px 2px 0px #1018280D"}}>
            <Link to="/rider/riders" className="font-[600] text-[16px] leading-[24px] text-[#1843E2] font-tekInter">No, change rider</Link>
            </li>

            <li className="pt-[12px] pr-[20px] pb-[12px] pl-[20px] border-[1px] bg-[#1843E2] border-[#1843E2] 
            rounded-[8px] gap-[8px]"
            style={{ boxShadow:"0px 1px 2px 0px #1018280D"}}>
            <Link to="/rider/riders" className="font-[600] text-[16px] leading-[24px] text-[#FFFFFF] font-tekInter">Yes,Assign Rider</Link>
            </li>
    </ul>

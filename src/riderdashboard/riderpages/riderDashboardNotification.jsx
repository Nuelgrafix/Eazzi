...
import RiderAllNotification from "../component/notification/riderAllNotification"
...
const RiderDashboardNotification = () => {
  ...
  return (
    ...
    <div className="w-full flex items-center justify-between">
        <div>
            <h1 className="outline-none w-full h-full lg:text-[32px] text-[24px] leading-[48px] text-[#5075FF] font-tekInter font-[700]">Notification</h1>
        </div>
...
export default RiderDashboardNotification

...
style={{boxShadow: "0px 8px 32px 0px #3326AE14"}}>
    <h1 className="text-[20px] leading-[24px] text-[#4F4F4F] font-[700] font-tekInter pt-[2rem]">Orders from {item.title}</h1>
...
export default RiderCustomerDetails;
